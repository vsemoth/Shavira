	...
	<div class="row">
		...
		{!! Form::model($product, ['route' => ['product.update',$product->id], 'method' => 'PATCH', 'files' => true]) !!}
			...
			<div class="form-group">
				...
				{{ Form::select('size', ['small' =>'Small', 'medium' => 'Medium', 'large' => 'Large', 'allsize' => 'All Size'], null, array('class' => 'form-control')) }}
			</div>
			...
			<div class="form-group">
				{{ Form::submit('Update', array('class' => 'btn btn-success btn-large')) }}
			</div>
